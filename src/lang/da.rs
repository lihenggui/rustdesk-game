...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("scam_text1", "Hvis du taler telefon med en person du IKKE kender, og IKKE stoler på, som har bedt dig om at bruge GameDesk til at forbinde til din PC, stop med det samme, og læg på omgående."),
        ...
        ("selinux_tip", "SELinux er aktiveret på din enhed, som kan forhindre GameDesk i at køre normalt."),
        ...
        ("floating_window_tip", "Det hjælper på at GameDesk baggrundstjenesten kører"),
